            ...
            if(strcmp(atual->Type, "MethodDecl")==0){
                ...
                while(aux1 != NULL){
                    if(strcmp(aux1->Type, "MethodHeader") == 0){
                        ...
                        auxVar = create_var(aux3->value, changeType(aux2->Type)); //ADD TO GLOBAL
                        ...
                        while(aux5 != NULL){ //WHILE EXISTS ParamDecl's
                            if(strcmp(aux5->Type, "NULL")!=0){
                                ...
                                auxParam = create_param_type(changeType(aux5->child->Type), (aux5->child)->brother->value);
            ...
            if(strcmp(atual->Type, "MethodDecl")==0){
                ...
                while(aux1 != NULL){
                    if(strcmp(aux1->Type, "MethodHeader") == 0){
                        ...
                        auxVar = create_var("return", changeType(aux2->Type)); //CREATE VAR TYPE
                        auxVar->flag = 0;
...
void printAnotedAST(node *current, int n){
    ...
    if(strcmp(current->Type, "NULL") == 0){
        ...
        if(current->value != NULL){
            if(current->n_params >=0 && itsExpression(current->Type) == 1){
            ...
            else if(current->anoted != NULL && itsExpression(current->Type) == 1){
            ...
            if(current->anoted != NULL && itsExpression(current->Type) == 1){
